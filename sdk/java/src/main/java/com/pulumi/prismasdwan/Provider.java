...
import com.pulumi.prismasdwan.ProviderArgs;
 ...
 * 
 */
@ResourceType(type="pulumi:providers:prismasdwan")
public class Provider extends com.pulumi.resources.ProviderResource {
    ...
    public Provider(String name, @Nullable ProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("prismasdwan", name, args == null ? ProviderArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
